...
function renderTabelle(){
  ...
  const section=(id,title,icon,subtitle,body,cls='')=>`<section class="tabella-gruppo-v17 ${cls}" data-table-section="${id}"><button class="tabella-head-v17" type="button" aria-expanded="true"><span class="tabella-icon-v17">${icon}</span><span><strong>${title}</strong><small>${subtitle}</small></span><b>⌃</b></button><div class="tabella-body-v17">${body}</div></section>`;
